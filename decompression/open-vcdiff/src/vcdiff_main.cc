...
using gflags::GetCommandLineFlagInfoOrDie;
using gflags::ShowUsageWithFlagsRestrict;
using gflags::SetVersionString;
...
int main(int argc, char** argv) {
  ...
  gflags::SetUsageMessage(kUsageString);
  gflags::SetVersionString(OPEN_VCDIFF_VERSION);
